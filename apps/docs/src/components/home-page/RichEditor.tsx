...
const RichEditor = () => {
    ...
    return (
        <div>
            ...
            >
                <Toolbar className="p-2 sticky rounded-t-xl top-0 border-b border-solid border-gray-200 bg-white z-99" />
                <Content />
            </Editor>
